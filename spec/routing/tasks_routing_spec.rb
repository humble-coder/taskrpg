...
describe TasksController do
  describe "routing" do
    ...
    it "routes to #clear" do
    	get("/tasks/clear").should route_to("tasks#clear")
    end

    it "routes to #restore" do
    	get("/tasks/1/restore").should route_to("tasks#restore", :id => "1")
    end

    it "routes to #complete" do
    	get("/tasks/1/complete").should route_to("tasks#complete", :id => "1")
    end
